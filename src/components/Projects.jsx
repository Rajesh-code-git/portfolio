      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-black rounded-xl overflow-hidden shadow-lg group">
          ...
          <div className="relative">
            <div
              ...
              style={{ backgroundImage: "url('/images/ecommerce.png')" }}
            ></div>
            {/* Overlay */}
            <div className="absolute inset-0 bg-black/70 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition">
              <a
                href="https://github.com/Rajesh-code-git/e-commerce-app"
              ...
              <a
                href="https://e-commerce-app-iota-amber.vercel.app/"
        ...
        <div className="bg-black rounded-xl overflow-hidden shadow-lg group">
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-black/70 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition">
              <a
                href="https://github.com/Rajesh-code-git/todo-app"
                className="bg-white text-black p-3 rounded-full"
              >
                <FaGithub />
              </a>
              ...
              <a
                href="https://todo-app-seven-puce-77.vercel.app/"
                className="bg-blue-500 p-3 rounded-full"
              >
                <FaExternalLinkAlt />
              </a>
